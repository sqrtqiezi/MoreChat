...
JUHEXBOT_CLOUD_API_URL="${JUHEXBOT_CLOUD_API_URL}"
...
# Aliyun OSS
ALICLOUD_OSS_REGION="${ALICLOUD_OSS_REGION}"
ALICLOUD_OSS_BUCKET="${ALICLOUD_OSS_BUCKET}"
ALICLOUD_OSS_ACCESS_KEY_ID="${ALICLOUD_OSS_ACCESS_KEY_ID}"
ALICLOUD_OSS_ACCESS_KEY_SECRET="${ALICLOUD_OSS_ACCESS_KEY_SECRET}"
